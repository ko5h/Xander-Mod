...
data.raw.recipe["steam-engine"].normal = {energy_required = 2, enabled = false, ingredients = {{"mechanical-steam-engine", 3}, {"forging-iron", 2}, {"electric-engine-unit", 2}}, result = "steam-engine"}
data.raw.recipe["steam-engine"].expensive = {energy_required = 2, enabled = false, ingredients = {{"mechanical-steam-engine", 6}, {"forging-iron", 5}, {"electric-engine-unit", 4}}, result = "steam-engine"}
...
data.raw.recipe["nuclear-reactor"].ingredients = {{"concrete", 2000}, {"lead-plate", 1000}, {"forging-alloy", 500}, {"control-2", 200}, {"heat-pipe", 20}, {"forging-zirconium", 200}, {"mechanism-2", 100}}
...
--XM High-Temperature Steam Turbine
{
	...
	energy_required = 10,
	enabled = false,
	ingredients = {{"forging-superalloy", 10}, {"forging-alloy", 20}, {"mechanism-2", 10}, {"mechanism-3", 5}, {"control-3", 2}, {"motor-3", 4}, {"pipe-superalloy", 20}, {"fused-basalt", 50}},
