...
data.raw["solar-panel-equipment"]["solar-panel-equipment"].sprite.filename = "__xander-mod-v1__/graphics/equipment/solar-panel-equipment-1.png"

--Personal Roboport Mark 2
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].sprite.filename = "__xander-mod-v1__/graphics/equipment/personal-roboport-mk2-equipment.png"
...
--Portable Fission Reactor
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/fission-reactor-equipment.png",
		width = 128,
		height = 128,
		priority = "medium"
	},
...
--Energy Shield Mark 3
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/energy-shield-mk3-equipment.png",
		width = 64,
		height = 64,
		priority = "medium"
	},
...
--Energy Shield Mark 4
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/energy-shield-mk4-equipment.png",
		width = 64,
		height = 64,
		priority = "medium"
	},
...
--Battery Mark 3
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/battery-mk3-equipment.png",
		width = 32,
		height = 64,
		priority = "medium"
	},
...
--Personal Laser Defense Mark 2
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/personal-laser-defense-mk2-equipment.png",
		width = 64,
		height = 64,
		priority = "medium"
	},
...
--Personal Laser Defense Mark 3
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/personal-laser-defense-mk3-equipment.png",
		width = 64,
		height = 64,
		priority = "medium"
	},
...
--Exoskeleton Equipment Mark 2
{
	...
	sprite =
	{
		filename = "__xander-mod-v1__/graphics/equipment/exoskeleton-mk2-equipment.png",
		width = 64,
		height = 128,
		priority = "medium"
	},
